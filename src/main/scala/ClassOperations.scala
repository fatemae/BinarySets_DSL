...
object ClassOperations :
  ...
  def getClassInfo(className :String, info: String):String = {
  ...
  private def checkCircularComposition(parent: String, classNm: String): Boolean = {
  ...
  private def checkForAbstractMethods(BaseClass: String, parentClass: String, parentType: String): Boolean ={
    //      println("BaseClass:"+BaseClass)
    //      println("parentClass:"+parentClass)
    val classType = getClassInfo(parentClass, typeModifier)
    if(classType!=null && !classType.equals(exceptionType)){
  ...
  def runMethod(scopeName: String, objectName: String, methodName: String, params: Parameters): Any = {
  ...
  private def hasAtleastOneAbstractMethod(name: String): Boolean = {
    bindingScope.getOrElse(name, null) match {
      case classDetails: mutable.Map[String, Any] => classDetails.getOrElse(method, null) match {
        case methods: mutable.Map[String, Any] =>
  ...
  def cloneInheritedClassMap(staticType: String, dynamicType: String, staticClassMap: mutable.Map[String, Any], dynamicClassMap: mutable.Map[String, Any]): mutable.Map[String, Any] ={
  ...
  def cloneClassMap(classMap: mutable.Map[String, Any]): mutable.Map[String, Any] ={
    val newMap: mutable.Map[String, Any] = mutable.Map[String, Any]()
  ...
  enum ClassOper:
    ...
    case ExceptionClassDef(name: String, oper:ClassOper*)
...
//          println(bindingScope)
        ...
        case ObjectType(name) => objectMap.getOrElse(className, None) match {
          case objects: mutable.Map[String, Any] =>
        ...
        case AbstractMethod(mName:String, params:Parameters) =>
          ...
          if(isAbstractType!=null && !isAbstractType.equals(exceptionType)){
        ...
        case Implements(interface: String)=>
          ...
          if(classType==null || (classType!=null && classType.equals(abstractType))) {
            ...
            if(newParentClassType==null || (newParentClassType!=null && !newParentClassType.equals(interfaceType))){
              ...
              if(parent==null){
                ...
                if (classType == null && !hasAbstractMethods) {
          ...
          }else if(classType!=null && classType.equals(interfaceType)){
        ...
        case ExceptionClassDef(name: String, opers : _*) =>
          defineClass(name, exceptionType, className+connector+name, opers)
